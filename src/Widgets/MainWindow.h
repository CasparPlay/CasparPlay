...
class WIDGETS_EXPORT MainWindow : public QMainWindow, Ui::MainWindow
{
    ...
    private:
        ...
        Q_SLOT void sendToDB();         // rakib inclusion
        Q_SLOT void sendScrollingText();
        Q_SLOT void sendCGPlayoutCmd();
        Q_SLOT void GenerateReport();
        Q_SLOT void PrepareRundown();
