...
//#include "Events/Rundown/SendDbRundownEvent.h"  // rakib inclusion

#include "../Core/Events/Rundown/SendDbRundownEvent.h"
...
class WIDGETS_EXPORT RundownTreeWidget : public QWidget, Ui::RundownTreeWidget
{
    ...
    public:
        ...
        void sendRundown(const SendDbRundownEvent&);
        void SendDbRundown(const SendDbRundownEvent&);   // rakib inclusion
        void InsertIntoDb();
        ...
        bool createConnection(QByteArray data);
