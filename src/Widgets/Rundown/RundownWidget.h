...
class WIDGETS_EXPORT RundownWidget : public QWidget, Ui::RundownWidget
{
    ...
    private:
        ...
        Q_SLOT void sendRundown(const SendDbRundownEvent&);
        Q_SLOT void SendDbRundown(const SendDbRundownEvent&);
        //Q_SLOT void sendRundown(const SendDbRundownEvent&);      // rakib inclusion
};
